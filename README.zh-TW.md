...
作為臺灣數位治理無任所大使、首任數位發展部長、全球首位非二元性別內閣成員，唐鳳於 2025 年獲頒[正命獎](https://rightlivelihood.org/the-change-makers/find-a-laureate/audrey-tang/)，表彰其「推進數位科技的社會應用，賦權公民、更新民主並修補社會裂痕」的貢獻，是該獎項史上首位臺灣得主。
...
[我們全民，才是超級智慧](https://www.youtube.com/watch?v=fqvdaHWH7a0&t=5s) — 主題演講與爐邊對談・Solve at MIT・2026 年 5 月
超級智慧不是在資料中心裡打造的，它就在會場之中。從「野火，還是篝火」，到把資料石油還原成土壤，以及仁工智慧的「地神（Kami）」。
...
<!-- section:CIVIC_AI -->
## 現階段工作・牛津大學 AI 倫理研究院: 仁工智慧 & 關懷六力

主流的 AI 安全論述是由上而下的：一套超級智慧系統，一次性對齊人類價值。但再多的「實然」永遠導不出「應然」。唐鳳與牛津大學的 Caroline Green 共同開發的[《仁工智慧》](https://civic.tw)提供了水平的替代方案——眾多有邊界、針對特定目的的 AI 智慧體，各自專注服務單一社群的關係健康。
...
AI 生成的黃仁勳詐騙廣告讓臺灣民眾損失數百萬元。唐鳳發送 20 萬則簡訊給全臺隨機選取的號碼，只問一個問題：該怎麼做？從回覆者中透過抽樣選出 447 位符合全國人口結構的代表，在 44 個會議室線上審議，當天由[可信任生成式 AI 對話引擎](https://taide.tw/)合成他們的提案。

最終產生三項共識措施：未簽署的廣告標示為可能詐騙、平台須為未經同意的深偽造成的損失負責、對未遵守的服務降速直到符合規範——針對行為者與行為管制，而非內容審查。85% 的與會者同意，法案獲得跨黨派支持通過，至 2026 年中，臺灣社群媒體上的冒用身分廣告已較 2024 年高峰減少 98%。

前往 civic.tw 閱讀完整架構 →

前往 pi.audreyt.org 在本機運行可究問模型 →

---

<!-- section:FILM -->
## 短片・導演：Cynthia Wade: 夠好的祖先（紀錄短片）
...
[**AI 與民主：拒絕被最佳化的權利**](/humanist-review) — The Humanist Review 創刊號 · 2026 年 7 月
真正的危險，不在機器把人模仿得多像，而在人開始把自己調整成機器的形狀。談代理、資訊流、照片之後的真實，以及為未被最佳化的生活辯護。

[協作式免疫系統](/collaborative-immune-system) — 日本自民黨總部 · 東京 · 2025 年 12 月
公眾協作制定規則，轉化為精準的法律義務。在民主社會中，最重要的防詐技術不是過濾器，而是「正當性」。

[夠好的祖先：參議院證詞](/good-enough-ancestor) — 加拿大參議院人權委員會 · 2026 年 4 月
AI 不只是自動化。它重新分配注意力、權威與議價能力。在民主社會中，這樣的重新分配必須可見、可爭辯，並且共同治理。

[透明之馬](/transparent-horse) — 2040 年的回望 · 2025
2040 年回望：我們如何策動和平並獲勝。這不是我們未能造神的故事。這是我們決定不需要神的故事。
...
| [A Vision of Democratic AI](https://www.digitalistpapers.com/essays/a-vision-of-democratic-ai) | With Divya Siddarth and Saffron Huang | Digitalist | 2024 |
| [*多元宇宙：協作技術與民主的未來*](https://plurality.net/zh) | 與衛谷倫及 Plurality 社群合著。達賴喇嘛、蔡英文總統、Vitalik Buterin 推薦。 | Book | 2024 |
...
唐鳳是**零時政府（g0v）**的核心貢獻者，零時政府是東亞最大的公民科技社群之一。唐鳳也在 **2014 年太陽花運動**中扮演關鍵角色，在占領立法院期間推動數位共識建立。唐鳳將直播與公民科技帶進運動中，證明基進透明能由下而上翻轉治理。

2016 年就任數位政委後，唐鳳落實基進透明與參與式民主平台，包含數百萬人使用的**公共政策網路參與平臺**。唐鳳任內臺灣民眾對政府的信任度從個位數上升到超過 70%，推動的創新包含 COVID-19 期間即時上線的**口罩地圖**、**簡訊實聯制**，以及開創性的**預先澄清機制**，防禦選舉期間的網路干預。唐鳳於 2024 年轉任數位治理無任所大使，這些平台、方法論、立法都比任期更長久——這正是「功遂身退」的實踐意義。
